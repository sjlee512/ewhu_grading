...
# 페이지4
    ...
    birth = st.date_input(label=f"{st.session_state['name']}님의 생일은 언제입니까", value=datetime.date(1980, 1, 1), min_value=datetime.date(1980, 1, 1), max_value=datetime.date(2000, 1, 1))
...
# 마지막페이지
elif st.session_state.page == 'page_final':
